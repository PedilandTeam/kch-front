...
import { fetcherJustOk } from '@/app/swr/fetcherJustOk';
...
export default function useAuthCheck() {
    ...
    const {data: userData, error: userError, isLoading: userIsLoading } = useSWR<IUser>(`${process.env.NEXT_PUBLIC_API_URL}/auth/user/check`, axiosFetcher)
