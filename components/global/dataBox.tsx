...
export default function DataBox({ title, data, link, linkText }: DataBox) {
    return (
        <div className="sm:h-32 h-20 min-w-1/12 lg:max-w-[40%] px-2 grid grid-cols-5 sm:grid-rows-2 grid-rows-1 justify-items-center items-center border-2 hover:bg-blue-600 hover:text-white duration-300 text-gray-600 rounded-xl">
