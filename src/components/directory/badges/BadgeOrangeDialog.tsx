        ...
        <DialogHeader>
          ...
          <div className="space-y-4">
            <div className="space-y-2 text-[15px]">
              <p>
                اطلاعات این صفحه از اینترنت جمع‌آوری شده و توسط مالک آن تایید
                نشده است. اگر شما مالک این واحد صنفی هستید، می‌توانید با احراز
                هویت و بروزرسانی اطلاعات این صفحه تیک آبی دریافت کرده و از
