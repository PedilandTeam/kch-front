...
export const AboutContent = () => {
  return (
    <section className="_about content">
      ...
      <div className="section">
        <h2>هدف ما!</h2>
        <p>هدف اصلی ما افزایش کیفیت و سهولت زندگی فارسی زبانان مهاجره!</p>
        <p>
        ...
        <ul>
          <li>
            ...
            یک دایرکتوری حرفه‌ای برای معرفی و رتبه‌بندی مشاغل و پزشکان
            فارسی‌زبان
          </li>
          <li>
            <span className="text-secondary font-semibold">
          ...
          <li>
            ...
            یک ساختار استاندارد برای ثبت آگهی‌های دسته‌بندی‌شده فارسی‌زبان
            (بـزودی)
          </li>
        </ul>
        <p>
