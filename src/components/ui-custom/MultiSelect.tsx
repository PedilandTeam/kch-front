        ...
        >
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                "flex h-auto min-h-10 items-center justify-between rounded-md border bg-white p-1 hover:bg-white [&_svg]:pointer-events-auto",
                  ...
                  >
                        ...
                        return (
                          ...
                          >
                            ...
                            <div
                              ...
                              className="-m-1 mr-1 flex h-4 w-4 cursor-pointer rounded-sm hover:bg-white/20 focus:ring-1 focus:ring-white/50 focus:outline-none"
                            >
                              <XCircle
                                className={cn(
                    ...
                    {selectedValues.length > responsiveSettings.maxCount && (
                      ...
                      >
                        ...
                        <XCircle
                          className={cn(
                            "text-muted-foreground mr-1 -ml-1 h-4 w-4 cursor-pointer",
          ...
          <PopoverContent
            ...
            style={{
              ...
              animationDelay: `${animationConfig?.delay || 0}s`,
              maxWidth: `min(${widthConstraints.maxWidth}, 91vw)`,
          ...
          >
            <Command>
              ...
              >
                ...
                {!hideSelectAll && searchValue.trim() === "" && (
                  <CommandGroup>
                    <CommandItem
                      key="all"
                      onSelect={toggleAll}
