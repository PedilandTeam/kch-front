...
import AnswerToQuestion from "../../app/(Site)/[countryOrSlug]/c/[questionId]/answerToQuestion";
...
import useGetQuestion from "../../app/(Site)/[countryOrSlug]/c/apiForum/useGetQuestion";
...
export const QuestionDetailsSection = ({ question }: { question: Question }) => {
  return (
            ...
            <div className="mb-2 flex items-center gap-2">
              ...
              <div className="flex w-auto items-center rounded-xl bg-blue-200 py-1 text-xs font-bold text-gray-700">
                {/* <button
                  ...
                  className="btn btn-ghost btn-xs xl:btn-sm rounded-xl font-medium"
                >
