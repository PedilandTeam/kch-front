  ...
  const slides = useMemo(
    () => [
      ...
      },
      {
        ...
        content:
          "در اینستاگرام و فیس‌بوک الگوریتم‌ها، و در تلگرام ادمین‌ها هستن که تعیین می‌کنن چه آگهی‌هایی رو ببینین. اما در AdsClub فقط شما انتخاب می‌کنین چه آگهی‌هایی و با چه موضوعاتی براتون ارسال بشه.",
        btnText: "متوجه شدم",
      },
      {
        id: 4,
        ...
        content:
          "در AdsClub، برخلاف پلتفرم‌های دیگه، خبری از بمباران تبلیغاتی، پیام‌های تکراری و غیرمرتبط، ربات‌ها و اسپم نیست. شما فقط آگهی‌هایی رو دریافت می‌کنین که با علاقه‌مندی‌ها و نیازهاتون هماهنگ باشن. اون هم تنها هفته‌ای یک بار.",
        btnText: "متوجه شدم",
      },
      {
        id: 5,
        ...
        content:
          "در AdsClub، برای ایجاد جذابیت و قدردانی از کاربران فعال و وفادار، یک سیستم امتیازدهی طراحی کردیم. با جمع‌آوری امتیازهای بیشتر، سطح کاربری‌تون ارتقا پیدا میکنه و دسترسی شما به خدمات و پیشنهادات ویژه فعال میشه.",
