      ...
      <div className="container">
        <div className="_wrap">
          ...
          <p className="my-3 text-sm">
            ...
            اتلاف وقت و سردرگمی در گروه‌های شلوغ تلگرامی، پاسخ دقیق و معتبر
            سوالات خود را پیدا کنید. چه در ابتدای مسیر مهاجرت باشید و چه در حال
            زندگی در کانادا، می‌توانید به راحتی با متخصصان و هموطنان با تجربه
            ارتباط بگیرید و از تجربیات واقعی آن‌ها استفاده کنید.
          </p>
