...
export const Footer = () => {
    ...
    return (
        <div className='mt-5 rounded-tl-3xl rounded-tr-3xl bg-[#1c39bb] pb-6 pt-10 text-gray-50 sm:mt-10 sm:rounded-none sm:pb-8'>
            <footer className='container footer footer-center mx-auto max-w-[1144px] px-3'>
                <div className='grid gap-3 text-[15px] sm:grid-flow-col sm:gap-4'>
                ...
                <div>
                    <div className='grid grid-flow-col gap-4'>
                        <Link
                            ...
                            target='_blank'
                            className='rounded-full bg-[#4961c9] p-3 hover:bg-[#d8aa3c]'
                        >
                            <svg
	...
	L4.1,2.8z'
                ...
                <div>
                    <p className='font-light'>
                        ...
                        <Link
                            href='/'
                            className='link-hover link mx-1 inline-flex'
                        >
            ...
            <Link
                ...
                id='toTopDiv'
            >
                <ChevronUpIcon className='h-[36px] w-[36px] stroke-blue-100' />
            </Link>
        </div>
    );
};
