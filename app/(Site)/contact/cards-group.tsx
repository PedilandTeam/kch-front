    ...
    return (
        <div className='container mx-auto mt-10 max-w-[1144px] px-3 sm:px-0'>
            <div className='card-group grid gap-4 sm:grid-cols-3 sm:gap-8'>
                <div className='card border-[2px] border-gray-100 shadow-lg'>
                    <div className='card-body p-8'>
                        <div className='icon flex justify-center'>
                            <ChatBubbleBottomCenterTextIcon className='h-[46px] w-[46px] stroke-blue-900' />
                        </div>
                        <h2 className='card-title mt-4 justify-center text-[18px]'>
                            پشتیبانی در تلگرام
                        </h2>
                        <p
                            className='text-center font-PinarLT text-[18px] text-gray-500'
                            dir='ltr'
                        >
                            <Link
                ...
                <div className='card border-[2px] border-gray-100 shadow-lg'>
                    <div className='card-body p-8'>
                        <div className='icon flex h-[46px] items-center justify-center'>
                            <svg
                ...
                <div className='card border-[2px] border-gray-100 shadow-lg'>
                    <div className='card-body p-8'>
                        <div className='icon flex justify-center'>
                            <AtSymbolIcon className='h-[46px] w-[46px] stroke-blue-900' />
                        </div>
                        <h2 className='card-title mt-4 justify-center text-[18px]'>
                            ارسال ایمیل
                        </h2>
