                ...
                <div className='mod-header flex flex-wrap items-center sm:col-span-4'>
                    <div className='border-r-[4px] border-secondary pl-3 pr-3 sm:border-r-[5px] sm:pl-0 sm:pr-5'>
                        ...
                        <div className='mb-2 font-medium leading-7 text-gray-500 sm:pl-5 sm:text-justify'>
                            <p className='mb-2'>
                                اگه خارج از ایران زندگی میکنی و تابحال به پیدا
                                کردن یه سرویس مشخص به زبـان فارسـی نیاز پیدا
                                کرده باشی، حتما با مشکل نبود اطلاعات منسجم و
                                معتبر در این زمینه مواجه شدی.
                            </p>
                            <p className='mb-2'>
                                راهنمای مشاغل کـوچـا که در دو دسته مشاغل و
                                پزشکان فـارسـی زبـان طبقه‌بندی شده، تصمیم داره
                                این مشکل بزرگ رو حل کنه. در همین راستا به تمام
                                مشاغلی که خارج از ایران فعالیت قانونی خودشون رو
                                به زبـان فارسـی هم ارائه می‌کنن؛ این امکان رو
                                میده تا با ایجاد یک پروفایل حرفه‌ای، به‌سادگی
                                خدمات و محصولات‌شون رو در دسترس سایر
                        ...
                        <div className='item group mb-3 flex sm:mb-0'>
                            <Link href={`/${currentCountry.code}/businesses`}>
                                <div className='image relative h-min overflow-hidden rounded-xl'>
                                    <Image
                                        src={
                                            '/images/modules/mod-business-01.webp'
                                        }
                                        width={400}
                                        height={560}
                                    ...
                                    <Image
                                        src={
                                            '/images/modules/mod-business-01-m.webp'
                                        }
                                        width={430}
                                        height={300}
                                        alt='Some Business People'
                        ...
                        <div className='item group mb-4 flex sm:mb-0'>
                            <Link href={`/${currentCountry.code}/doctors`}>
                                <div className='image relative h-min overflow-hidden rounded-xl'>
                                    <Image
                                        src={
                                            '/images/modules/mod-doctor-01.webp'
                                        }
                                        width={400}
                                        height={560}
                                        alt='a doctor'
                                    ...
                                    <Image
                                        src={
                                            '/images/modules/mod-doctor-01-m.webp'
                                        }
                                        width={430}
                                        height={300}
                                        alt='a doctor'
