  ...
  return (
    <div className="rounded-md border border-gray-200 p-5">
      <div className="item-contact">
        ...
        <div className="ct-address flex justify-between py-3 border-b border-gray-200">
        ...
        <div className="item-social flex pt-3">
          <div className="sc-instagram flex hover:cursor-pointer">
            <div className="group inline-flex">
              <svg
                className="w-6 h-6 ml-4 text-gray-400 group-hover:text-pink-700 fill-current"
          ...
          <div className="sc-facebook flex hover:cursor-pointer">
            <div className="group inline-flex">
              <svg
                className="w-6 h-6 ml-4 text-gray-400 group-hover:text-blue-500 fill-current"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
              >
          ...
          <div className="sc-linkedin flex hover:cursor-pointer">
            <div className="group inline-flex">
              <svg
                className="w-6 h-6 ml-4 text-gray-400 group-hover:text-sky-700 fill-current"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
              >
          ...
          <div className="sc-youtube flex hover:cursor-pointer">
            <div className="group inline-flex">
              <svg
                className="w-6 h-6 text-gray-400 group-hover:text-red-600 fill-current"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
              >
